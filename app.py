...
with col_contenido:
    ...
    if "Puedo Sulfatar" in menu:
        ...
        st.write("Añade nuevas parcelas mediante coordenadas, edita las existentes o elimina aquellas que ya no cultives.")
        ...
        with st.form("form_nueva_finca"):
            ...
            with c_f2:
                ...
                with c_coord1:
                    lat_nueva = st.number_input("Latitud (ej: 42.4658)", value=42.4658, format="%.4f")
                with c_coord2:
                    lon_nueva = st.number_input("Longitud (ej: -2.4499)", value=-2.4499, format="%.4f")
